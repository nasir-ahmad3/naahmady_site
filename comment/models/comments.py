...
class Comment(models.Model):
    ...
    email = models.EmailField(blank=True, verbose_name = "ایمیل  ادرس")
    parent = models.ForeignKey('self', on_delete=models.CASCADE, null=True, blank=True, verbose_name = "والذ")
    content_type = models.ForeignKey(ContentType, on_delete=models.CASCADE, verbose_name = "موقیعت")
    ...
    posted = models.DateTimeField(default=timezone.now, editable=False, verbose_name = "زمان پوست شده")
